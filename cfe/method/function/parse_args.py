...
# local execute:
#   python ./cfe/method/function/parse_args.py --function_name cf_paga --adata_path ./method_docker_input/adata.h5ad --prior_information ./method_docker_input/prior_information.json --parameters ./method_docker_input/parameters.json --output_filename ./method_docker_output/output.pkl
