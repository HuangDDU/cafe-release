...
from .fate_cafe_docker_backend import CFEDockerBackend
...
# TODO: more methods for cafe.method.xxx
...
#     # for pytest unit test, use cafe.method.cf_paga to run function directly
...
#     # for easy call FateMethod object, use 'cafe.method.paga' to run with multiple backend
